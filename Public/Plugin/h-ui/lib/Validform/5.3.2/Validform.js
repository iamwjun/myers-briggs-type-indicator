...
(function($,win,undef){
	...
	var tipmsg={//默认提示文字;
		...
		v:"所填信息没有经过验证，请稍后…",
		// p:"正在提交数据…"
		p : '<div style="width:100%;height:40px;background:url('+jsObj['plugins_H-ui']+'/lib/layer/2.1/skin/default/loading-0.gif) no-repeat center center;"></div>'
	}
	$.Tipmsg=tipmsg;
			...
			*/
			...
			if(flag){
				...
				if(settings.ajaxPost || ajaxPost==="ajaxPost"){
					...
					// 获取值问题
					// var ooa = curform.serialize();
					// var oob = $('#formValidform');
					// alert(oob.find('textarea[name="content"]').val());
					// alert($(document.getElementById('kindeditor').contentWindow.document.body).html());
					// return false;
					var localconfig={
						type: "POST",
						async:true,
