...
a):e.err?alert(e.err):(m.push(e.msg),g=!0);(!g||c)&&d.removeModal();c&&g&&f(m);return g}var m=[],j=g.html5Upload,p=j?g.upMultiple:1,h,s=e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u50b3\u4e2d\uff0c\u8acb\u7a0d\u5019\u2026\u2026<br /></div>'),r='<img src="'+ua+'img/loading.gif">';if(Ca||!j||a.nodeType&&(!(h=a.files)||!h[0].name)){if(!Wa(a.value,c))return;s.append(r);c=new d.html4Upload(a,b,i)}else{h||(h=a);a=h.length;if(a>p){alert("\u8acb\u4e0d\u8981\u4e00\u6b21\u4e0a\u50b3\u8d85\u904e"+
p+"\u500b\u6587\u4ef6");return}for(p=0;p<a;p++)if(!Wa(h[p].name,c))return;var l=e('<div class="xheProgress"><div><span>0%</span></div></div>');s.append(l);c=new d.html5Upload("filedata",h,b,i,function(a){if(0<=a.loaded){var b=Math.round(100*a.loaded/a.total)+"%";e("div",l).css("width",b);e("span",l).text(b+" ( "+Xa(a.loaded)+" / "+Xa(a.total)+" )")}else l.replaceWith(r)})}d.showModal("\u6587\u4ef6\u4e0a\u50b3\u4e2d(Esc\u53d6\u6d88\u4e0a\u50b3)",s,320,150);c.start()};this.html4Upload=function(a,b,
...
s.remove())})};this.showModal=function(a,b,c,f,i){if(ta)return!1;d.panelState=S;S=!1;ea=g.layerShadow;c=c?c:g.modalWidth;f=f?f:g.modalHeight;K=e('<div class="xheModal" style="width:'+(c-1)+"px;height:"+f+"px;margin-left:-"+Math.ceil(c/2)+"px;"+(h&&7>pa?"":"margin-top:-"+Math.ceil(f/2)+"px")+'">'+(g.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="\u95dc\u9589 (Esc)" tabindex="0" role="button"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");
