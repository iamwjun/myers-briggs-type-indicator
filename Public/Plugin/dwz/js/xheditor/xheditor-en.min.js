...
curse:"Curse",crazy:"Crazy",angry:"Angry",ohmy:"Oh my",awkward:"Awkward",panic:"Panic",shy:"Shy",cute:"Cute",envy:"Envy",proud:"Proud",struggle:"Struggle",quiet:"Quiet",shutup:"Shut up",doubt:"Doubt",despise:"Despise",sleep:"Sleep",bye:"Bye"}}},ka={Cut:{t:"Cut (Ctrl+X)"},Copy:{t:"Copy (Ctrl+C)"},Paste:{t:"Paste (Ctrl+V)"},Pastetext:{t:"Paste as plain text",h:h?0:1},Blocktag:{t:"Block tag",h:1},Fontface:{t:"Font family",h:1},FontSize:{t:"Font size",h:1},Bold:{t:"Bold (Ctrl+B)",s:"Ctrl+B"},Italic:{t:"Italic (Ctrl+I)",
...
"i")))if(d){if(d!==b[1])return 2}else d=b[1];else return 1;return d}(b);1===k?alert("Upload file extension required for this: "+j.replace(/\w+:,/g,"")):2===k?alert("You can only drag and drop the same type of files."):k&&d.startUpload(b,g["up"+k+"Url"],"*",function(a){var b=[],c;(c=g.onUpload)&&c(a);for(var f=0,j=a.length;f<j;f++)c=a[f],url=M(c,"string")?c:c.url,"!"===url.substr(0,1)&&(url=url.substr(1)),b.push(url);d.exec(k);e("#xhe"+k+"Url").val(b.join(" "));e("#xheSave").click()});return!1}});
(j=g.shortcuts)&&e.each(j,function(a,b){d.addShortcuts(a,b)});aa++;Ma=!0;g.fullscreen?d.toggleFullscreen():g.sourceMode&&setTimeout(d.toggleSource,20);return!0};this.remove=function(){d.hidePanel();U();G.unbind("focus",d.focus);Ya.unbind("submit",U).unbind("reset",J);g.submitID&&e("#"+g.submitID).unbind("mousedown",U);e(window).unbind("unload beforeunload",U).unbind("resize",Na);e(document).unbind("mousedown",Oa);e("#"+ja).remove();e("#"+za).remove();G.show();Ma=!1};this.saveBookmark=function(){if(!x){d.focus();
var a=d.getRng(),a=a.cloneRange?a.cloneRange():a;ha={top:fa.scrollTop(),rng:a}}};this.loadBookmark=function(){if(!x&&ha){d.focus();var a=ha.rng;if(h)a.select();else{var b=d.getSel();b.removeAllRanges();b.addRange(a)}fa.scrollTop(ha.top);ha=null}};this.focus=function(){x?e("#sourceCode",l).focus():W.focus();if(h){var a=d.getRng();a.parentElement&&a.parentElement().ownerDocument!==l&&d.setTextCursor()}return!1};this.setTextCursor=function(a){var b=d.getRng(!0),c=l.body;if(h)b.moveToElementText(c);else{for(var e=
a?"lastChild":"firstChild";3!=c.nodeType&&c[e];)c=c[e];b.selectNode(c)}b.collapse(a?!1:!0);h?b.select():(a=d.getSel(),a.removeAllRanges(),a.addRange(b))};this.getSel=function(){return l.selection?l.selection:W.getSelection()};this.getRng=function(a){var b,c;try{a||(b=d.getSel(),c=b.createRange?b.createRange():0<b.rangeCount?b.getRangeAt(0):null),c||(c=l.body.createTextRange?l.body.createTextRange():l.createRange())}catch(e){}return c};this.getParent=function(a){var b=d.getRng(),c;h?c=b.item?b.item(0):
b.parentElement():(c=b.commonAncestorContainer,b.collapsed||b.startContainer===b.endContainer&&2>b.startOffset-b.endOffset&&b.startContainer.hasChildNodes()&&(c=b.startContainer.childNodes[b.startOffset]));a=a?a:"*";c=e(c);c.is(a)||(c=e(c).closest(a));return c};this.getSelect=function(a){var b=d.getSel(),c=d.getRng(),f=!0,f=!c||c.item?!1:!b||0===c.boundingWidth||c.collapsed;if("text"===a)return f?"":c.text||(b.toString?b.toString():"");c.cloneContents?(a=e("<div></div>"),(c=c.cloneContents())&&a.append(c),
c=a.html()):c=M(c.item)?c.item(0).outerHTML:M(c.htmlText)?c.htmlText:c.toString();f&&(c="");c=d.processHTML(c,"read");c=d.cleanHTML(c);return c=d.formatXHTML(c)};this.pasteHTML=function(a,b){if(x)return!1;d.focus();var a=d.processHTML(a,"write"),c=d.getSel(),f=d.getRng();if(b!==$){if(f.item){var i=f.item(0),f=d.getRng(!0);f.moveToElementText(i);f.select()}f.collapse(b)}a+="<"+(h?"img":"span")+' id="_xhe_temp" width="0" height="0" />';if(f.insertNode){if(0<e(f.startContainer).closest("style,script").length)return!1;
f.deleteContents();f.insertNode(f.createContextualFragment(a))}else"control"===c.type.toLowerCase()&&(c.clear(),f=d.getRng()),f.pasteHTML(a);var i=e("#_xhe_temp",l),m=i[0];h?(f.moveToElementText(m),f.select()):(f.selectNode(m),c.removeAllRanges(),c.addRange(f));i.remove()};this.pasteText=function(a,b){a||(a="");a=d.domEncode(a);a=a.replace(/\r?\n/g,"<br />");d.pasteHTML(a,b)};this.appendHTML=function(a){if(x)return!1;d.focus();a=d.processHTML(a,"write");e(l.body).append(a);d.setTextCursor(!0)};this.domEncode=
function(a){return a.replace(nb,function(a){return mb[a]})};this.setSource=function(a){ha=null;if("string"!==typeof a&&""!==a)a=z.value;x?e("#sourceCode",l).val(a):(g.beforeSetSource&&(a=g.beforeSetSource(a)),a=d.cleanHTML(a),a=d.formatXHTML(a),a=d.processHTML(a,"write"),h?(l.body.innerHTML='<img id="_xhe_temp" width="0" height="0" />'+a,e("#_xhe_temp",l).remove()):l.body.innerHTML=a)};this.processHTML=function(a,b){if("write"===b){a=a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g,
...
e.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i,function(a,b){k=b.match(/^(["']?)(.*)\1/)[2];k=k.split(",");k[1]||(k[1]=k[0],k[0]="");"default"===k[0]&&(k[0]="");return g.emotMark?a:""});else if("a"===d)!e.match(/ href=[^ ]/i)&&e.match(/ name=[^ ]/i)&&(y+=" xhe-anchor"),i&&(f="></a>");else if("table"===d&&!c&&(a=e.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i),!a||a[1].match(/^(["']?)\s*0\s*\1$/)))y+=" xhe-border";var Z,e=e.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g,function(a,
b,c){b=b.toLowerCase();c=c.match(/^(["']?)(.*)\1/)[2];aft="";if(h&&b.match(/^(disabled|checked|readonly|selected)$/)&&c.match(/^(false|0)$/i)||"img"===d&&k&&"src"===b)return"";b.match(/^(src|href)$/)&&(aft=" _xhe_"+b+'="'+c+'"',F&&(c=V(c,"abs",F)));y&&"class"===b&&(c+=" "+y,y="");R&&"style"===b&&"span"===d&&c.match(/(^|;)\s*(font-family|font-size|color|background-color)\s*:\s*[^;]+\s*(;|$)/i)&&(Z=!0);return" "+b+'="'+c+'"'+aft});k&&(a=Y+(k[0]?k[0]:"default")+"/"+k[1]+".gif",e+=' src="'+a+'" _xhe_src="'+
a+'"');Z&&(e+=' class="Apple-style-span"');y&&(e+=' class="'+y+'"');return"<"+c+d+e+f});h&&(a=a.replace(/&apos;/ig,"&#39;"));if(!R)var c=function(a,b,c,d,e,f){var b="",i,k;(i=d.match(/font-family\s*:\s*([^;"]+)/i))&&(b+=' face="'+i[1]+'"');if(i=d.match(/font-size\s*:\s*([^;"]+)/i)){i=i[1].toLowerCase();for(var y=0;y<T.length;y++)if(i===T[y].n||i===T[y].s){k=y+1;break}k&&(b+=' size="'+k+'"',d=d.replace(/(^|;)(\s*font-size\s*:\s*[^;"]+;?)+/ig,"$1"))}if(k=d.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)){if(i=
...
"editMode"+Q),h?b.contentEditable="true":l.designMode="On",qa&&(d._exec("inserthtml","-"),e("#"+za).show().focus().hide()),g="Source mode";else{d.pasteHTML('<span id="_xhe_cursor"></span>',!0);f=d.getSource(!0);a=f.indexOf('<span id="_xhe_cursor"></span>');if(!Ca)a=f.substring(0,a).replace(/\r/g,"").length;f=f.replace(/(\r?\n\s*|)<span id="_xhe_cursor"><\/span>(\s*\r?\n|)/,function(a,b,c){return b&&c?"\r\n":b+c});h?b.contentEditable="false":l.designMode="Off";c.attr("scroll","no").attr("class","sourceMode").html('<textarea id="sourceCode" wrap="soft" spellcheck="false" style="width:100%;height:100%" />');
i=e("#sourceCode",c).blur(d.getSource)[0];g="WYSIWYG mode"}x=!x;d.setSource(f);d.focus();x?i.setSelectionRange?i.setSelectionRange(a,a):(i=i.createTextRange(),i.move("character",a),i.select()):d.setTextCursor();n.find("[cmd=Source]").attr("title",g).find("span").text(g);n.find("[cmd=Source],[cmd=Preview]").toggleClass("xheEnabled");n.find(".xheButton").not("[cmd=Source],[cmd=Fullscreen],[cmd=About]").toggleClass("xheEnabled").attr("aria-disabled",x?!0:!1);setTimeout(La,300)}};this.showPreview=function(){var a=
g.beforeSetSource,b=d.getSource();a&&(b=a(b));var a="<html><head>"+P+"<title>Preview</title>"+(F?'<base href="'+F+'"/>':"")+"</head><body>"+b+"</body></html>",b=window.screen,b=window.open("","xhePreview","toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width="+Math.round(0.9*b.width)+",height="+Math.round(0.8*b.height)+",left="+Math.round(0.05*b.width)),c=b.document;c.open();c.write(a);c.close();b.focus()};this.toggleFullscreen=function(a){if(la!==a){var a=e("#"+ja).find(".xheLayout"),
b=e("#"+ja),c=jQuery.browser.version,c=h&&(6==c||7==c);la?(c&&G.after(b),a.attr("style",Za),B.height(O-n.outerHeight()),e(window).scrollTop(Pa),setTimeout(function(){e(window).scrollTop(Pa)},10)):(c&&e("body").append(b),Pa=e(window).scrollTop(),Za=a.attr("style"),a.removeAttr("style"),B.height("100%"),setTimeout(Na,100));qa?(e("#"+za).show().focus().hide(),setTimeout(d.focus,1)):c&&d.setTextCursor();la=!la;b.toggleClass("xhe_Fullscreen");e("html").toggleClass("xhe_Fullfix");n.find("[cmd=Fullscreen]").toggleClass("xheActive");
setTimeout(La,300)}};this.showMenu=function(a,b){var c=e('<div class="xheMenu"></div>'),f=a.length,i=[];e.each(a,function(a,b){"-"===b.s?i.push('<div class="xheMenuSeparator"></div>'):i.push("<a href=\"javascript:void('"+b.v+'\')" title="'+(b.t?b.t:b.s)+'" v="'+b.v+'" role="option" aria-setsize="'+f+'" aria-posinset="'+(a+1)+'" tabindex="0">'+b.s+"</a>")});c.append(i.join(""));c.click(function(a){a=a.target;if(!e.nodeName(a,"DIV"))return d.loadBookmark(),b(e(a).closest("a").attr("v")),d.hidePanel(),
!1}).mousedown(N);d.saveBookmark();d.showPanel(c)};this.showColor=function(a){var b=e('<div class="xheColor"></div>'),c=[],f=Ta.length,i=0;e.each(Ta,function(a,b){0===i%7&&c.push((0<i?"</div>":"")+"<div>");c.push("<a href=\"javascript:void('"+b+'\')" xhev="'+b+'" title="'+b+'" style="background:'+b+'" role="option" aria-setsize="'+f+'" aria-posinset="'+(i+1)+'"></a>');i++});c.push("</div>");b.append(c.join(""));b.click(function(b){b=b.target;if(e.nodeName(b,"A"))return d.loadBookmark(),a(e(b).attr("xhev")),
d.hidePanel(),!1}).mousedown(N);d.saveBookmark();d.showPanel(b)};this.showPastetext=function(){var a=e('<div><label for="xhePastetextValue">Use Ctrl+V on your keyboard to paste the text.</label></div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),b=e("#xhePastetextValue",a);e("#xheSave",a).click(function(){d.loadBookmark();var a=b.val();a&&d.pasteText(a);
d.hidePanel();return!1});d.saveBookmark();d.showDialog(a)};this.showLink=function(){var a='<div><label for="xheLinkUrl">Link URL: </label><input type="text" id="xheLinkUrl" value="http://" class="xheText" /></div><div><label for="xheLinkTarget">Target:&nbsp;&nbsp; </label><select id="xheLinkTarget"><option selected="selected" value="">Default</option><option value="_blank">New window</option><option value="_self">Same window</option><option value="_parent">Parent window</option></select></div><div style="display:none"><label for="xheLinkText">Link Text:</label><input type="text" id="xheLinkText" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>',
b=ga.find("a[name]").not("[href]"),c=0<b.length;if(c){var f=[];b.each(function(){var a=e(this).attr("name");f.push('<option value="#'+a+'">'+a+"</option>")});a=a.replace(/(<div><label for="xheLinkTarget)/,'<div><label for="xheLinkAnchor">Anchor: &nbsp;&nbsp;</label><select id="xheLinkAnchor"><option value="">None selected</option>'+f.join("")+"</select></div>$1")}var a=e(a),i=d.getParent("a"),m=e("#xheLinkText",a),j=e("#xheLinkUrl",a),p=e("#xheLinkTarget",a),b=e("#xheSave",a),w=d.getSelect();c&&a.find("#xheLinkAnchor").change(function(){var a=
e(this).val();""!=a&&j.val(a)});if(1===i.length){if(!i.attr("href"))return v=null,d.exec("Anchor");j.val(L(i,"href"));p.attr("value",i.attr("target"))}else""===w&&m.val(g.defLinkText).closest("div").show();g.upLinkUrl&&d.uploadInit(j,g.upLinkUrl,g.upLinkExt);b.click(function(){d.loadBookmark();var a=j.val();(""===a||0===i.length)&&d._exec("unlink");if(""!==a&&"http://"!==a){var b=a.split(" "),c=p.val(),f=m.val();if(1<b.length){d._exec("unlink");w=d.getSelect();var g='<a href="xhe_tmpurl"',Z=[];""!==
c&&(g+=' target="'+c+'"');for(var g=g+">xhe_tmptext</a>",f=""!==w?w:f?f:a,h=0,pb=b.length;h<pb;h++)a=b[h],""!==a&&(a=a.split("||"),c=g,c=c.replace("xhe_tmpurl",a[0]),c=c.replace("xhe_tmptext",a[1]?a[1]:f),Z.push(c));d.pasteHTML(Z.join("&nbsp;"))}else a=b[0].split("||"),f||(f=a[0]),f=a[1]?a[1]:""!==w?"":f?f:a[0],0===i.length?(f?d.pasteHTML('<a href="#xhe_tmpurl">'+f+"</a>"):d._exec("createlink","#xhe_tmpurl"),i=e('a[href$="#xhe_tmpurl"]',l)):f&&!R&&i.text(f),L(i,"href",a[0]),""!==c?i.attr("target",
c):i.removeAttr("target")}d.hidePanel();return!1});d.saveBookmark();d.showDialog(a)};this.showAnchor=function(){var a=e('<div><label for="xheAnchorName">Anchor name: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),b=d.getParent("a"),c=e("#xheAnchorName",a),f=e("#xheSave",a);if(1===b.length){if(b.attr("href"))return v=null,d.exec("Link");c.val(b.attr("name"))}f.click(function(){d.loadBookmark();
var a=c.val();a?0===b.length?d.pasteHTML('<a name="'+a+'"></a>'):b.attr("name",a):1===b.length&&b.remove();d.hidePanel();return!1});d.saveBookmark();d.showDialog(a)};this.showImg=function(){var a=e('<div><label for="xheImgUrl">Img URL:&nbsp; </label><input type="text" id="xheImgUrl" value="http://" class="xheText" /></div><div><div><label for="xheImgAlt">Alt text: </label><input type="text" id="xheImgAlt" /></div><div><label for="xheImgAlign">Alignment:</label><select id="xheImgAlign"><option selected="selected" value="">Default</option><option value="left">Left</option><option value="right">Right</option><option value="top">Top</option><option value="middle">Middle</option><option value="baseline">Baseline</option><option value="bottom">Bottom</option></select></div><div><label for="xheImgWidth">Width:&nbsp; &nbsp; </label><input type="text" id="xheImgWidth" style="width:40px;" /> <label for="xheImgHeight">Height:&nbsp; &nbsp;</label><input type="text" id="xheImgHeight" style="width:40px;" /></div><div><label for="xheImgBorder">Border:&nbsp; &nbsp;</label><input type="text" id="xheImgBorder" style="width:40px;" /></div><div><label for="xheImgHspace">Hspace:&nbsp;&nbsp;&nbsp;</label><input type="text" id="xheImgHspace" style="width:40px;" /> <label for="xheImgVspace">Vspace:&nbsp; &nbsp;</label><input type="text" id="xheImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),
...
e('<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;outline:none;" role="dialog" tabindex="-1"><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.1.14 (build 120701)</p>xhEditor is a platform independent WYSWYG XHTML editor based by jQuery,released as Open Source under <a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>.</p>Copyright &copy; <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>');
...
var i=e('<span class="xheUpload"><input type="text" style="visibility:hidden;" tabindex="-1" /><input type="button" value="'+g.upBtnText+'" class="xheBtn" tabindex="-1" /></span>'),m=e(".xheBtn",i),j=g.html5Upload,p=j?g.upMultiple:1;a.after(i);m.before(a);b=b.replace(/{editorRoot}/ig,A);if("!"===b.substr(0,1))m.click(function(){d.showIframeModal("Upload file",b.substr(1),f,null,null)});else{i.append('<input type="file"'+(1<p?' multiple=""':"")+' class="xheFile" size="13" name="filedata" tabindex="-1" />');
var h=e(".xheFile",i);h.change(function(){d.startUpload(h[0],b,c,f)});setTimeout(function(){a.closest(".xheDialog").bind("dragenter dragover",N).bind("drop",function(a){var a=a.originalEvent.dataTransfer,e;j&&a&&(e=a.files)&&0<e.length&&d.startUpload(e,b,c,f);return!1})},10)}};this.startUpload=function(a,b,c,f){function i(a,c){var e=Object,g=!1;try{e=eval("("+a+")")}catch(i){}e.err===$||e.msg===$?alert(b+" upload interface error!\r\n\r\nreturn error:\r\n\r\n"+a):e.err?alert(e.err):(m.push(e.msg),
g=!0);(!g||c)&&d.removeModal();c&&g&&f(m);return g}var m=[],j=g.html5Upload,p=j?g.upMultiple:1,h,s=e('<div style="padding:22px 0;text-align:center;line-height:30px;">File uploading,please wait...<br /></div>'),r='<img src="'+ua+'img/loading.gif">';if(Ca||!j||a.nodeType&&(!(h=a.files)||!h[0].name)){if(!Wa(a.value,c))return;s.append(r);c=new d.html4Upload(a,b,i)}else{h||(h=a);a=h.length;if(a>p){alert("Please do not upload more then "+p+" files.");return}for(p=0;p<a;p++)if(!Wa(h[p].name,c))return;var l=
e('<div class="xheProgress"><div><span>0%</span></div></div>');s.append(l);c=new d.html5Upload("filedata",h,b,i,function(a){if(0<=a.loaded){var b=Math.round(100*a.loaded/a.total)+"%";e("div",l).css("width",b);e("span",l).text(b+" ( "+Xa(a.loaded)+" / "+Xa(a.total)+" )")}else l.replaceWith(r)})}d.showModal("File uploading(Esc cancel)",s,320,150);c.start()};this.html4Upload=function(a,b,c){var d="jUploadFrame"+(new Date).getTime(),g=this,h=e('<iframe name="'+d+'" class="xheHideArea" />').appendTo("body"),
j=e('<form action="'+b+'" target="'+d+'" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"),p=e(a),l=p.clone().attr("disabled","true");p.before(l).appendTo(j);this.remove=function(){null!==g&&(l.before(p).remove(),h.remove(),j.remove(),g=null)};this.onLoad=function(){var a=h[0].contentWindow.document,b=e(a.body).text();a.write("");g.remove();c(b,!0)};this.start=function(){j.submit();h.load(g.onLoad)};return this};this.html5Upload=function(a,b,c,d,e){function g(b,
c,d,e){h=new XMLHttpRequest;upload=h.upload;h.onreadystatechange=function(){4===h.readyState&&d(h.responseText)};upload?upload.onprogress=function(a){e(a.loaded)}:e(-1);h.open("POST",c);h.setRequestHeader("Content-Type","application/octet-stream");h.setRequestHeader("Content-Disposition",'attachment; name="'+encodeURIComponent(a)+'"; filename="'+encodeURIComponent(b.name)+'"');h.sendAsBinary&&b.getAsBinary?h.sendAsBinary(b.getAsBinary()):h.send(b)}function j(a){e&&e({loaded:r+a,total:o})}for(var h,
l=0,s=b.length,r=0,o=0,k=this,n=0;n<s;n++)o+=b[n].size;this.remove=function(){h&&(h.abort(),h=null)};this.uploadNext=function(a){a&&(r+=b[l-1].size,j(0));(!a||a&&!0===d(a,l===s))&&l<s&&g(b[l++],c,k.uploadNext,function(a){j(a)})};this.start=function(){k.uploadNext()}};this.showIframeModal=function(a,b,c,f,g,h){function j(){try{r.callback=l,r.unloadme=d.removeModal,e(r.document).keydown(I),n=r.name}catch(a){}}function l(a){r.document.write("");d.removeModal();null!=a&&c(a)}var b=e('<iframe frameborder="0" src="'+
b.replace(/{editorRoot}/ig,A)+(/\?/.test(b)?"&":"?")+"parenthost="+location.host+'" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'),o=b.eq(0),s=b.eq(1);d.showModal(a,b,f,g,h);var r=o[0].contentWindow,n;j();o.load(function(){j();if(n){var a=!0;try{n=eval("("+unescape(n)+")")}catch(b){a=!1}if(a)return l(n)}s.is(":visible")&&(o.show().focus(),s.remove())})};this.showModal=function(a,b,c,f,i){if(ta)return!1;d.panelState=S;S=!1;ea=g.layerShadow;c=c?c:g.modalWidth;f=
f?f:g.modalHeight;K=e('<div class="xheModal" style="width:'+(c-1)+"px;height:"+f+"px;margin-left:-"+Math.ceil(c/2)+"px;"+(h&&7>pa?"":"margin-top:-"+Math.ceil(f/2)+"px")+'">'+(g.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="Close (Esc)" tabindex="0" role="button"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");Fa=e('<div class="xheModalOverlay"></div>').appendTo("body");0<ea&&(Ea=e('<div class="xheModalShadow" style="width:'+K.outerWidth()+
"px;height:"+K.outerHeight()+"px;margin-left:-"+(Math.ceil(c/2)-ea-2)+"px;"+(h&&7>pa?"":"margin-top:-"+(Math.ceil(f/2)-ea-2)+"px")+'"></div>').appendTo("body"));e(".xheModalContent",K).css("height",f-(g.modalTitle?e(".xheModalTitle").outerHeight():0)).html(b);h&&6===pa&&(Ga=e("select:visible").css("visibility","hidden"));e(".xheModalClose",K).click(d.removeModal);Fa.show();0<ea&&Ea.show();K.show();setTimeout(function(){K.find("a,input[type=text],textarea").filter(":visible").filter(function(){return"hidden"!==
e(this).css("visibility")}).eq(0).focus()},10);ta=!0;Ha=i};this.removeModal=function(){Ga&&Ga.css("visibility","visible");K.html("").remove();0<ea&&Ea.remove();Fa.remove();Ha&&Ha();ta=!1;S=d.panelState};this.showDialog=function(a,b){var c=e('<div class="xheDialog"></div>'),f=e(a),i=e("#xheSave",f);if(1===i.length){f.find("input[type=text],select").keypress(function(a){if(13===a.which)return i.click(),!1});f.find("textarea").keydown(function(a){if(a.ctrlKey&&13===a.which)return i.click(),!1});i.after(' <input type="button" id="xheCancel" value="Cancel" />');
e("#xheCancel",f).click(d.hidePanel);if(!g.clickCancelDialog){sa=!1;var h=e('<div class="xheFixCancel"></div>').appendTo("body").mousedown(N),j=B.offset();h.css({left:j.left,top:j.top,width:B.outerWidth(),height:B.outerHeight()})}c.mousedown(function(){oa=!0})}c.append(f);d.showPanel(c,b)};this.showPanel=function(a,b){if(!v.target)return!1;t.html("").append(a).css("left",-999).css("top",-999);da=e(v.target).closest("a").addClass("xheActive");var c=da.offset(),d=c.left,c=c.top,c=c+(da.outerHeight()-
1);ca.css({left:d+1,top:c,width:da.width()}).show();var i=document.documentElement,h=document.body;if(d+t.outerWidth()>(window.pageXOffset||i.scrollLeft||h.scrollLeft)+(i.clientWidth||h.clientWidth))d-=t.outerWidth()-da.outerWidth();i=g.layerShadow;0<i&&ba.css({left:d+i,top:c+i,width:t.outerWidth(),height:t.outerHeight()}).show();if((i=e("#"+ja).offsetParent().css("zIndex"))&&!isNaN(i))ba.css("zIndex",parseInt(i,10)+1),t.css("zIndex",parseInt(i,10)+2),ca.css("zIndex",parseInt(i,10)+3);t.css({left:d,
top:c}).show();b||setTimeout(function(){t.find("a,input[type=text],textarea").filter(":visible").filter(function(){return"hidden"!==e(this).css("visibility")}).eq(0).focus()},10);Qa=S=!0};this.hidePanel=function(){S&&(da.removeClass("xheActive"),ba.hide(),ca.hide(),t.hide(),S=!1,sa||(e(".xheFixCancel").remove(),sa=!0),Qa=oa=!1,X=null,d.focus(),d.loadBookmark())};this.exec=function(a){d.hidePanel();var b=ka[a];if(!b)return!1;if(null===v){v={};var c=n.find(".xheButton[cmd="+a+"]");if(1===c.length)v.target=
c}if(b.e)b.e.call(d);else switch(a=a.toLowerCase(),a){case "cut":try{if(l.execCommand(a),!l.queryCommandSupported(a))throw"Error";}catch(f){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+X) instead.")}break;case "copy":try{if(l.execCommand(a),!l.queryCommandSupported(a))throw"Error";}catch(i){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+C) instead.")}break;case "paste":try{if(l.execCommand(a),!l.queryCommandSupported(a))throw"Error";}catch(m){alert("Currently not supported by your browser, use keyboard shortcuts(Ctrl+V) instead.")}break;
