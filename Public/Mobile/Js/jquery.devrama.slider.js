...
(function ($) {
    var DrSlider = function (element, options) {
        ...
        this.options = {
            ...
            navigationColor: 'url(/App_Themes/Default/Images/icon2.png) no-repeat center',
            navigationHoverColor: 'url(/App_Themes/Default/Images/icon1.png) no-repeat center',
            navigationHighlightColor: 'url(/App_Themes/Default/Images/icon1.png) no-repeat center',
    ...
    DrSlider.prototype = {
        ...
        _updateNavigation: function () {
            ...
            if (!this.options.userCSS) {
                this.$ele_projector.next('.navigation').find('.nav-link').css({
                    'background': this.options.navigationColor
                });
                this.$ele_projector.next('.navigation').find('.nav-link.index' + this.current_slide).css({
                    'background': this.options.navigationHighlightColor
                });
            }
        },
        ...
        _attachNavigation: function () {
            ...
            //				navigation_html += '<span class="nav-link index'+i+'" data-num="'+i+'">'+(i+1)+'</span>';
                navigation_html += '<span class="nav-link index' + i + '" data-num="' + i + '"></span>';
            ...
            if (!this.options.userCSS) {
                ...
                $nav_link.hover(function () {
                    $(this).css({
                        'background': that.options.navigationHoverColor
                    });
                }, function () {
                    $(this).css({
                        'background': $(this).data('num') == that.current_slide ? that.options.navigationHighlightColor : that.options.navigationColor
                    });
                });
