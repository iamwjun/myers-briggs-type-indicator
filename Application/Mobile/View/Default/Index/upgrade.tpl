...
<head>
	...
	<title>安装升级-{$config.web_title}</title>
	...
	<script type="text/javascript">
     function upload_bill()
	 {
	   ...
	   $.getJSON("{:U('Index/show_repair')}",{type: 3},function(json){
	     if(json)
		 {
		   $('#z_photo').empty();
...
<body>
	...
	<div class="apply_repair">
		<div class="apply_repair_box">
			...
			<div class="apply_repair_type">安装升级</div>
			<input type="hidden" name="" id="project_tpye" value="2" />
...
<!--项目申请js-->
<script src="__JS__/project_application_anzhuang.js" type="text/javascript" charset="utf-8"></script>
