...
<body style="overflow-x:hidden;width:100%">
  ...
  <div class="main" style="width:100%;height:auto;background:#5d65e1">
     <!--<img src="__IMAGES__/ques_bg.jpg" style="width:100%;height:auto">-->
    <style>
     #content p img{
      width:100%;
     }
     ...
     <div class="result" style="width:90%;height:auto;position:absolute;padding-bottom:50px;background:rgb(112, 115, 232);border:5px solid #FFF;top:5%;left:5%;display:block">
        ...
        <div id="content" style="width:80%;height:auto;background:#FFF;float:left;margin:5% 0px 0px 5%;font-size:26px;color:rgb(112, 115, 232);padding:5%">
           {$res}
        </div>
     </div>
