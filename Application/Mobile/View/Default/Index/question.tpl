    ...
    <script type="text/javascript">    
	 ...
	 function chioce(score,obj)
	 {
       ...
       if(page<cont)
       {
	       ...
	       window.location="{:U('Index/question')}?sex="+sex+"&page="+turn+"&score="+total_score+"&open_id="+open_id;
	   }
	   else{
      ...
      function h5_pay()
      {
        ...
        $.ajax({
             ...
             data:"money=29.9&sex="+sex+"&score="+score+"&category=1&page="+page,
             success:function(date){
...
<body style="overflow-x:hidden;width:100%">
  ...
  <div class="main" style="width:100%;height:1240px;">
     ...
     <div id="h5_pay" style="height:40px;background:#FFF;border-radius:10px;font-size:26px;background:rgb(207, 53, 53);color:#FFF;text-align:center;line-height:40px;font-weight:bold;padding:16px 26px 16px 26px;position:absolute;top:84%;left:26%;display:none" onclick="h5_pay()">点击支付29.9元查看测试结果</div>
