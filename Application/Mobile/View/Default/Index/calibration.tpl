...
<head>
	...
	<title>检测校准-{$config.web_title}</title>
	...
	<script type="text/javascript">
     function upload_bill()
	 {
	   ...
	   $.getJSON("{:U('Index/show_repair')}",{type: 2},function(json){
	     if(json)
		 {
		   $('#z_photo').empty();
...
<body>
	...
	<div class="apply_repair">
		<div class="apply_repair_box">
			...
			<div class="apply_repair_type">检测校准</div>
...
<!--项目申请js-->
<script src="__JS__/project_application_jiance.js" type="text/javascript" charset="utf-8"></script>
