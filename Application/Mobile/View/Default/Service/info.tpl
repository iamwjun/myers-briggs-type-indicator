...
<head>
	...
	<title>服务详情-{$config.web_title}</title>
	...
	<![endif]-->
	<style type="text/css">
		.serve_article{overflow: hidden;}
		.serve_article p{text-indent:0 !important;}
		.serve_article img{max-width: 100% !important; height: auto !important;}
	</style>
</head>
<body>
	<!--头部-->
	...
	<div class="serve">
		<div class="serve_body">
			...
			<div class="serve_title">
				{$info.title}
				<a href="tel:{$config.copyright}" class="mui-icon mui-icon-phone"><span>联系我们</span></a>
			</div>
