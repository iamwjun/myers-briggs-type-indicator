	...
	<div class="user_center">
		<div class="feedback_box">
		 <form action="" method="post">
			<ul>
				<li>
					<input type="text" name="company" id="company_name" value="{$userinfo.company}" placeholder="" />
				</li>
			</ul>
			<div class="apply_repair_submit mui-clearfix">
				<input type="submit" id="company_name_submit" name="ok" value="确定修改" />
			</div>
		 </form>
		</div>
	</div>
