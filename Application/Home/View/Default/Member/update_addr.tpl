	...
	<div class="user_center">
		<div class="feedback_box">
		 <form action="" method="post">
			<ul>
				<li>
					<input type="text" name="company_addr" id="company_address" value="{$userinfo.company_addr}" placeholder="" />
				</li>
			</ul>
			<div class="apply_repair_submit mui-clearfix">
				<input type="submit" id="company_address_submit" name="ok" value="确定修改" />
			</div>
		 </form>
		</div>
	</div>
