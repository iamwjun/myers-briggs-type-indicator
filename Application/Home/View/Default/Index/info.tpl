...
<head>
	...
	<title>{$info.title}-{$config.web_title}</title>
...
<body style="background:#FFF">
	...
	<!--详情内容-->
	<style>
     .content p{color:#3e3a3a;}
	</style>
	<div class="apply_repair">
		
		<div class="title" style="font-size:18px; color:#3e3a3a; text-align:center; margin:19px 0px 0px 0px">{$info.title}</div>
		<div class="timeinfo" style="font-size:16px; color:#b1acac; text-align:center; margin:19px 0px 0px 0px">发布日期：{$info.create_time|date='Y-m-d',###}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;阅读数：{$info.visit}</div>
        <div class="content" style="width:90%; margin-top:20px; margin-left:5%; color:#000; line-height:28px">
          {$info.content}
        </div>
	</div>
