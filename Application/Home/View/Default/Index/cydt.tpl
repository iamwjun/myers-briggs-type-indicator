...
<div class="category" style="width:1420px; height:48px; background:#efeded;">
   ...
   <a style="width:100px; height:46px; float:left;text-align:center;line-height:46px;color:#000; font-size:14px; border-bottom:2px solid #00a4c0;font-family:'苹方中黑';margin-left:2%;cursor:pointer">产业动态</a>
</div>
...
<div class="news_content" style="width:1420px; height:auto; float:left; margin-top:20px">
   ...
   <a href="{:U('Index/news_info',array('id'=>$vo['id'],'type'=>'cydt'))}">
