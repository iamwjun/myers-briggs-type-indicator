...
<div class="category" style="width:1420px; height:48px; background:#efeded;">
   <a href="{:U('Index/jtyw',array('page'=>1))}" style="width:100px; height:46px; float:left;text-align:center;line-height:46px;color:#000; font-size:14px; font-family:'苹方中黑';margin-left:1%;cursor:pointer">集团要闻</a>
   <a style="width:100px; height:46px; float:left;text-align:center;line-height:46px;color:#000; font-size:14px; border-bottom:2px solid #00a4c0;font-family:'苹方中黑';margin-left:2%;cursor:pointer">基地动态</a>
...
<div class="news_content" style="width:1420px; height:auto; float:left; margin-top:20px">
   ...
   <volist name="list" id="vo">
     <a href="{:U('Index/news_info',array('id'=>$vo['id'],'type'=>'jddt'))}">
