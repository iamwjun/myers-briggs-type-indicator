...
<head>
	...
	<style type="text/css">
		...
		.news_article p{text-indent:0 !important;}
		.news_article img{max-width: 100% !important; height: auto !important;}
	</style>
</head>
<body>
	<!--头部-->
	...
	<div class="news">
		<div class="news_body">
			<div class="news_title">
				<h5>{$info.title}</h5>
				<p><?php echo date('Y年m月d日 H:i',$info['create_time'])?><span>{$info.visit}</span>次浏览</p>
			</div>
