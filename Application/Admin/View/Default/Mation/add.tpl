							...
							<div>
				    			<span class="select-box radius width-130">
							    	<select name="title" class="select select-class" >
						                ...
						                <option value="20-35">20-35分</option>
						                <option value="35-50">35-50分</option>
						                <option value="50-65">50-65分</option>
						                <option value="65-85">65-85分</option>
						                <option value="85-100">85-100分</option>
						            </select>
								</span>
							</div>
						</div>
				    			...
				    			<span class="select-box radius width-130">
							    	<select name="category" class="select" datatype="*" nullmsg="请选择分类" onchange="if(this.value=='情感测试'){$('#sex').css('display','block')}else{$('#sex').css('display','none')}">
						                ...
						                <volist name="classList" id="volist">
											<option value="{$volist['title']}">{$volist['title']}</option>
						                </volist>
						            </select>
								</span>
							</div>
