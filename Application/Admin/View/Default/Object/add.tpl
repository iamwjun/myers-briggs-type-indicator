		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-9">
							...
							<input type="text" name="title" value="" datatype="*" nullmsg="菜单名称不能为空" placeholder="菜单名称" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						<label class="form-label col-1">菜单图标上传：</label>
						<div class="formControls col-9">
							<div class="uploader-thum-container">
								<div id="fileList" class="uploader-list"></div>
								<div id="filePicker">选择图片</div>
								<input type="hidden" name="picture" value="" id="singleImageUpload" datatype="*" nullmsg="请上传图标" />
					...
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="hidden" name="pid" value="{$_GET['pid']}" />
							<input type="text" name="btn_link" value="" datatype="*" nullmsg="跳转地址不能为空" placeholder="跳转地址" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
