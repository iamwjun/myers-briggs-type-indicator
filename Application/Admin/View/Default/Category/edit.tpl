		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-5">
							<input type="text" name="title" value="{$dataInfo['title']}" datatype="*" nullmsg="标题不能为空" placeholder="标题" class="input-text radius" />
					...
					<div class="row cl">
						...
						<div class="formControls col-5">
							<textarea name="intro" dragonfly="true" onKeyUp="textarealength(this,100)" placeholder="描述或链接" class="textarea radius">{$dataInfo['intro']}</textarea>
