...
<block name="main">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>&nbsp;操作节点列表
	...
	<div class="pd-20">
	    <div class="text-c">
	    	<form action="" method="post">
		    	...
		    	<!-- 群组标题 -->
				<input type="text" name="title" value="{$paramter['title']}" placeholder="输入节点标题" class="input-text radius width-200" />
				<!-- 搜索按钮 -->
	    ...
	    <div class="cl pd-5 bg-1 bk-gray mt-20">
	        <span class="l">
				...
				<a href="javascript:void(0);" onclick="layer_show('添加节点','__URL__/add/pid/{$paramter['pid']}','600','350')" class="btn btn-primary radius">
