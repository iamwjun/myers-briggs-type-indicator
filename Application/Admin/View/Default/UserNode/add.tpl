		...
		<form action="__URL__/create" method="post" class="form form-horizontal" id="formValidform">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="title" value="" datatype="*2-16" nullmsg="节点标题不能为空" placeholder="节点标题" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="name" value="" datatype="*2-30" nullmsg="节点名称不能为空" placeholder="节点名称" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
