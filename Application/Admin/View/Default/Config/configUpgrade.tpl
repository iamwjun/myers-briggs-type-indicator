    	...
    	<div class="panel-body">
	    	<div class="row cl">
            	...
            	<div class="formControls col-5">
					<input type="text" name="upgrade_rule[consume]" value="{$dataInfo['upgrade_rule'][consume]}" class="input-text config_upgrade_input" />
					<span style="color:red;">元获得1成长值</span>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-1">
            	...
            	<div class="formControls col-5">
					<input type="text" name="upgrade_rule[past]" value="{$dataInfo['upgrade_rule'][past]}" class="input-text config_upgrade_input" />
					<span style="color:red;">次获得1成长值</span>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-1">
                	...
                	<div class="formControls col-5">
					<input type="text" name="upgrade_rule[build]" value="{$dataInfo['upgrade_rule'][build]}" class="input-text config_upgrade_input" />
					<span style="color:red;">人获得1成长值</span>
					</div>
			</div>
			<div class="row cl">
				<label class="form-label col-1">
                	...
                	<div class="formControls col-5">
					<input type="text" name="upgrade_rule[manage]" value="{$dataInfo['upgrade_rule'][manage]}" class="input-text config_upgrade_input" />
					<span style="color:red;">人获得1成长值</span>
					</div>
			</div>	
		</div>
