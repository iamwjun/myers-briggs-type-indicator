		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-9">
							...
							<input type="text" name="title" value="" datatype="*" nullmsg="不能为空" placeholder="基地名称" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
                   ...
                   <!--  <div class="row cl">
						...
						<div class="formControls col-9">
							<script id="editor1" name="picture" type="text/plain" style="width:100%;height:400px;"></script>
						</div>
						<div class="col-2"> </div>
					</div> -->
