    ...
    <div class="pd-20">
        ...
        <div class="text-c">
            <form action="" method="post">
                <!-- 用户名 -->
                <input type="text" name="title" value="{$search['title']}" placeholder="输入信息标题" class="input-text radius width-200" />
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:void(0);" onclick="layer_full('添加信息','__URL__/add/pid/16','','');" class="btn btn-primary radius">
                    ...
                    <volist name="dataList" id="volist">
                        <tr class="text-c">
                            ...
                            <td class="td-manage">
                                ...
                                <a href="javascript:void(0);" onclick="layer_full('编辑信息','__URL__/edit/id/{$volist['id']}','','');" title="编辑信息" class="ml-5">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
